<?php
	...
	{
	 header('Location:attendence/dashboard.php');
	}
...
<html lang="en">
<head>
	<title>Login To Your Attendence System</title>
	<meta charset="UTF-8">
	...
	<div class="limite">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="attendence.php" onsubmit="return logincheck()">
					<span class="login100-form-title p-b-20 text-uppercase" style="margin-top: -50px;">
						Login to Your Attendence system
					</span>
