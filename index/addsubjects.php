...
<?php
	if (!empty($_POST['addsubjectscheck'])) 
	{
		$SubjectsName = htmlspecialchars(strtoupper($_POST['SubjectsName']));
		...
		if (mysqli_num_rows($query2) > 0) 
		{
			...
			{
				if (($row['SubjectsName']==$SubjectsName)&&($row['BoardsName']==$Boards)&&($row['ClassesName']==$Classes)&&($row['GroupsName']==$Groups))
				{
					echo 
						'<input type="hidden" >
						<script>
		...
		if ($i==$no_Of_subjects) 
		{
			...
			$date = date('d/m/Y');
			$addnewsubjects = "INSERT INTO subjects(CampusId,DisciplineName,ClassesName,GroupsName,BoardsName,SubjectsName,CreatedDate,IsActive)
						VALUES ('$CampusId','$Discipline','$Classes','$Groups','$Boards','$SubjectsName','$date','$ActiveStatus')";
			if (mysqli_query($conn, $addnewsubjects)) 
			{
			    echo 
					'<input type="hidden" >
						<script>
			...
			{
				 echo "Error: " . $addnewsubjects . "<br>" . mysqli_error($conn);
			 	echo 
					'<input type="hidden" >
						<script>
	       					...
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation mb-5" novalidate style="box-shadow: 1px 1px 10px;" action="addsubjects.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="SubjectsName" class="form-control text-uppercase form-control-sm" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row mt-5">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="addsubjectscheck" value="true">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
