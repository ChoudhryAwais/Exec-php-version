...
<?php
	...
	{
		$groupsId=$_POST['check'];
		$GroupsName = "SELECT GroupsName,ClassesName,IsActive 
					  FROM groups
					  WHERE GroupsId='$groupsId'";
		$query1 = mysqli_query($conn,$GroupsName);
		$Groups_Name = mysqli_fetch_array($query1);
		$groups_actual_name = $Groups_Name['GroupsName'];
		$classes_actual_name = $Groups_Name['ClassesName'];
        $actual_isactive = $Groups_Name['IsActive'];
	}
	else
	{
...
<?php
	...
	$disciplinedata = "SELECT DisciplineName
				 ...
				 WHERE CampusId = '$CampusId' AND IsActive='Yes';
				";
	$query4 = mysqli_query($conn,$disciplinedata);
?>
	       				...
	       				<div class="row">
	       					...
	       					<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 text-right">
	       						<a href="viewgroups.php"> 
	       							<button class="btn btn-sm btn-secondary mt-2 mr-4 text-white" style="border-radius: 40px;"><i class="fa fa-eye pr-1"></i>View Groups</button>
	       						</a>
	       					</div>
	       				</div>
	       				<div class="row">
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="viewgroups.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="GroupsName" class="form-control text-uppercase form-control-sm" value="<?php echo $groups_actual_name?>" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row mt-5">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="groupseditcheck" value="true">
