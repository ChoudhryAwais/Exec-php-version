            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="addstudentfeevoucher.php" method="post" name="forms" class="form-group needs-validation" novalidate onsubmit="return validation()">
                    ...
                    <div class="container">
                          ...
                          while ($row = mysqli_fetch_assoc($query3)) 
                          {
                            ?>
                              <div class="col-xl-3 col-md-4" style="font-size: 13px">
                                <input onclick='feecalculator()' oninput="feecalculator2()" type="checkbox" id="sub<?php echo $noofsubj?>" name="sub[]" value="<?php echo $row['SubjectsName']?>">
                          ...
                          <div class="container p-2" style="box-shadow: 1px 1px 8px">
                            <div class="row text-center">
                              ...
                              <div class="col-xl-4">
                                ...
                                <input type="text" name="specialtotalshow" id="specialtotalshow" class="form-control form-control-sm text-center" value="0" disabled style="cursor: no-drop;">
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-center">
                          ...
                          <button class="btn btn-sm btn-success" type="submit" name="submit">Save<i class="fas fa-arrow-right pl-2"></i></button>
                          <input type="hidden" name="studentcheck3" value="true">
                          <input type="hidden" name="onetimecheck" value="0">
...
<script>
  function feecalculator() 
  {
    ...
    if (noofstudysub>discountupto) 
    {
      ...
      discountpackage.value = discountpercentage;
    }
    else
    {
      var package = document.getElementById('package');
