...
<?php
	if (!empty($_POST['adddisciplinecheck'])) 
	{
		$DisciplineName = htmlspecialchars(strtoupper($_POST['DisciplineName']));
		...
		if (mysqli_num_rows($query2) > 0) 
		{
			...
			{
				if ($row['DisciplineName']==$DisciplineName) 
				{
					echo 
						'<input type="hidden" >
						<script>
		...
		{
			$date = date('d/m/Y');
			$addnewdiscipline = "INSERT INTO discipline(CampusId,DisciplineName,CreatedDate,IsActive)
						VALUES ('$CampusId','$DisciplineName','$date','$ActiveStatus')";
			if (mysqli_query($conn, $addnewdiscipline)) 
			{
			    echo 
					'<input type="hidden" >
					<script>
	       					...
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="adddiscipline.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="DisciplineName" class="form-control form-control-sm text-uppercase" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="adddisciplinecheck" value="true">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
