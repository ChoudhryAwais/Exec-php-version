            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="addstudentsubject.php" method="post" name="forms" class="form-group needs-validation" novalidate>
