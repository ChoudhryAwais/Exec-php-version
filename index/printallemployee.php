...
?>
<?php
if (empty($_POST['printallemployeecheck1'])) 
{
...
else
{
  ...
  //                 ";
  // $query = mysqli_query($conn,$Studentdata);
  // $studentlistdata = mysqli_fetch_array($query);
  // $sname = $studentlistdata['First_Name'];
  // $sfname = $studentlistdata['Last_Name'];
  // $gender =$studentlistdata['Gender'];
  // $dob =$studentlistdata['DOB'];
  // $sreligion =$studentlistdata['Religion'];
  // $sdomicile =$studentlistdata['Domicile'];
  // $scnic =$studentlistdata['CNIC'];
  // $snationality =$studentlistdata['Nationality'];
  // $saddress =$studentlistdata['Address'];
  // $sphone =$studentlistdata['Phone'];
  // $scell =$studentlistdata['Cell'];
  // $semail =$studentlistdata['Email'];
  // $gname =$studentlistdata['Parent_Name'];
  // $gcnic =$studentlistdata['Parent_CNIC'];
  // $gphone =$studentlistdata['Parent_Contact'];
  // $gcell =$studentlistdata['Parent_Cell'];
  // $gemail =$studentlistdata['Parent_Email'];

  // $group = $studentlistdata['Groups'];
  // $class = $studentlistdata['Class'];
  // $batch = $studentlistdata['Batch'];
  // $status = $studentlistdata['Status'];
  // $board = $studentlistdata['Board_Uni_School'];
  // $sub = $studentlistdata['Subjects'];
  // $countersub = $studentlistdata['No_of_Subjects'];
  // $actualfee = $studentlistdata['Actual_Fee'];
  // $discount = $studentlistdata['Total_discount'];
  // $total = $studentlistdata['Total_Fee'];
  // $admissionfee = $studentlistdata['Admission_Total'];
  // $tuitionfee = $studentlistdata['Tuition_Total'];
  // $specialfee = $studentlistdata['Special_Total'];
  // $submitby = $studentlistdata['Submit_By']; 
...
<body>    
  ...
  <?php
    foreach ($printall as $idofemployee) 
    { 
      ...
      ?>   
        ...
        <div class="row mt-1 wholetop m-1" style="background-color: #343A40">
        ...
        <footer style="background-color:#343A40;margin-top:56px;margin-right: 1px;margin-left: 1px" class="p-1">
          <div class="row">
