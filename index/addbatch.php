...
<?php
	if (!empty($_POST['addbatchcheck'])) 
	{
		$BatchName = htmlspecialchars(strtoupper($_POST['BatchName']));
		...
		{
			$date = date('d/m/Y');
			$addnewbatch = "INSERT INTO batch(CampusId,BatchName,CreatedDate,IsActive)
						VALUES ('$CampusId','$BatchName','$date','$ActiveStatus')";
			if (mysqli_query($conn, $addnewbatch)) 
			{
			    echo 
					'<input type="hidden" >
					<script>
	       					...
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="addbatch.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input type="text" name="BatchName" class="form-control form-control-sm text-uppercase" required onkeyup="spacefilter(this)">
	       											</td>
	       											<td>
	       									...
	       									<div class="row">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="addbatchcheck" value="true">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
