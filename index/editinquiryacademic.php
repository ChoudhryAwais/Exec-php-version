...
?>
<?php
if (empty($_POST['editinquirycheck1'])) 
{
...
else
{
  ...
  $group = $editinquirydata['Groups'];
  $batch = $editinquirydata['Batch'];
  $status = $editinquirydata['Status'];
  $board = $editinquirydata['Board_Uni_School'];
            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="editinquirysubject.php" method="post" name="forms" class="form-group needs-validation" novalidate>
                    ...
                    <div class="container">
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-right">
                          ...
                          <input type="hidden" name="editinquirycheck2" value="true">
                        </div>
                      </div>
                    </div>
                  </form>
