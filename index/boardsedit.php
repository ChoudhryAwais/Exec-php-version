...
<?php
	...
	{
		$boardsId=$_POST['check'];
		$BoardsName = "SELECT BoardsName,GroupsName,ClassesName,IsActive 
					  FROM boards
					  WHERE BoardsId='$boardsId'";
		$query1 = mysqli_query($conn,$BoardsName);
		$Boards_Name = mysqli_fetch_array($query1);
		$boards_actual_name = $Boards_Name['BoardsName'];
		$groups_actual_name = $Boards_Name['GroupsName'];
		$classes_actual_name = $Boards_Name['ClassesName'];
        $actual_isactive = $Boards_Name['IsActive'];
	}
	else
	{
		header('Location:viewboards.php');
	}
?>
<!DOCTYPE html>
<html>
	       					...
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="mb-5 form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="viewboards.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="BoardsName" class="form-control text-uppercase form-control-sm" value="<?php echo $boards_actual_name?>" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row mt-5">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="boardseditcheck" value="true">
	       											<input type="hidden" name="boardsId" value="<?php echo $boardsId?>">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
