...
else
{
  ...
  $subjects = $_POST['studentsubject'];
  $studentsubjects = implode(' ',$subjects);
            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="viewemployee.php" method="post" name="forms" class="form-group needs-validation" novalidate enctype="multipart/form-data">
                    ...
                    <div class="container">
                      ...
                      <div class="row container">
                        <div class="col-xl-12 text-center">
                          <span class="text-dark">Sign in time :</span>
                          <input type="Time" name="signintime" class="form-control-sm" required>
                          <span>Sign out time :</span>
                          <input type="Time" name="signouttime" class="form-control-sm" required>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-xl-12 mt-3">
                          <div>
                            <div class="container table-responsive" style="font-size: 13px">
                              <table class="text-center table-sm table table-striped">
                                <tr style="background-color:#323E6F;color: white;">
                                  ...
                                  <th>Boards</th>
                                  <th>Subjects</th>
                                  <th width="15%">Fix Salary</th>
                                  <th width="15%">Percentage Salary</th>
                                ...
                                <?php
                                  ...
                                  else
                                  {
                                    ...
                                    foreach ($subjects as  $sub) 
                                    {
                                      $subjectsdata = "SELECT * 
                                              FROM subjects
                                              WHERE CampusId= '$CampusId' AND SubjectsId='$sub'
                                      ...
                                      while($row = mysqli_fetch_assoc($query)) 
                                      {
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><input type="number" name="fixsalary<?php echo$i?>" class="form-control form-control-sm" required></td>
                                            <td><input type="number" name="persalary<?php echo$i?>" class="form-control form-control-sm" required></td>
                                          </tr>
                                        <?php
