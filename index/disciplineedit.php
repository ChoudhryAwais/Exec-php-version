...
<?php
	...
	{
        header('Location:viewdiscipline.php');	
	}
	else
	{
		$disciplineId=$_POST['check'];
		require "connectdatabase.php";
		$DisciplineName = "SELECT DisciplineName,IsActive 
					  FROM discipline
					  WHERE DisciplineId='$disciplineId'";
		$query1 = mysqli_query($conn,$DisciplineName);
		$discipline_Name = mysqli_fetch_array($query1);
		$discipline_actual_name = $discipline_Name['DisciplineName'];
        $actual_isactive = $discipline_Name['IsActive'];
	}
?>
<!DOCTYPE html>
<html>
       				...
       				<div class="container">
	       				<div class="row">
	       					...
	       					<div class="col-xl-9 col-lg-9 col-md-9 col-sm-9 text-right">
	       						<a href="viewdiscipline.php"> 
	       							<button class="btn btn-sm btn-secondary mt-2 mr-4 text-white" style="border-radius: 40px;box-shadow: 1px 1px 5px"><i class="fa fa-eye pr-1"></i>View Discipline</button>
	       						</a>
	       					</div>
	       				</div>
	       				<div class="row">
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="viewdiscipline.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="DisciplineName" class="form-control form-control-sm text-uppercase" value="<?php echo $discipline_actual_name?>" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="disciplineeditcheck" value="true">
	       											<input type="hidden" name="disciplineId" value="<?php echo $disciplineId?>">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
