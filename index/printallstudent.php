...
?>
<?php
if (empty($_POST['printallstudentcheck1'])) 
{
...
<body>    
  ...
  <?php
    foreach ($printall as $idofstudent) 
    { 
      ...
      $studentlistdata = mysqli_fetch_array($query);
      $rollno = $studentlistdata['Roll_No'];
      $sname = $studentlistdata['First_Name'];
      $sfname = $studentlistdata['Last_Name'];
      $gender =$studentlistdata['Gender'];
      $dob =$studentlistdata['DOB'];
      ...
      ?>   
        ...
        <div class="row mt-1 wholetop m-1" style="background-color: #433F40">
                  ...
                  <div class="col-lg-4 rollc">
                    <table class="table">
                      <tr class="table-bordered">
                        ...
                        <td class="pl-5 border" style="color: black"><?php echo$rollno?></td>
                      </tr>
                    </table>
                  </div>
