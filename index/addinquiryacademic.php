            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="addinquirysubject.php" method="post" name="forms" class="form-group needs-validation" novalidate>
                    ...
                    <div class="container">
                      <div class="row mt-2">
                        <div class="col-xl-12 p-1 h6 text-center text-white font-weight-bold text-uppercase" style="background-color: #323E6F;">Student Detail
                        </div>
                      </div>
                      <table class="table" style="box-shadow: 1px 1px 6px">
                        <tr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-6 col-md-6">
                          <select name="board" class="form-control form-control-sm mt-3" required>
                            <option value="" disabled selected>Boards</option>
                            <?php
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-right">
                          ...
                          <input type="hidden" name="inquirycheck1" value="true">
                        </div>
                      </div>
                    </div>
                  </form>
