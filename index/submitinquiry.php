          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 text-dark text-center p-1 h5 text-capitalize" style="border-radius: 0px 0px 80px 80px;">
                <div class="text-white" style="box-shadow: 1px 1px 2px black;border-radius: 0px 0px 50px 50px;background-color: #0047AB">Submit Inquiry</div>
              </div>
                ...
                <div class="container mb-5">
                  <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 h6 text-center">
                      <div class="container text-white p-1" style="box-shadow: 1px 1px 10px;border-radius: 20px 20px 0px 0px;background-color: #03D913">
                        General Information
                      </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 h6 text-center">
                    ...
                    <div class="col-xl-3 col-lg-3  col-md-3 col-sm-3  h6 text-center">
                      <div class="container text-white p-1" style="box-shadow: 1px 1px 10px black;border-radius: 20px 20px 0px 0px;background-color: #03D913">
                        Fee Voucher
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="container">
                      ...
                      <div class="row" id='halfs'>
                        <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 mt-1">
                          <input type="number" oninput="feecalculator1()" onkeyup="feecalculator()" style="display: none" name="days" id="days" class="form-control form-control-sm" placeholder="Number of Days" value="<?php echo$daysinmonth?>" required>
                        </div>                             
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-center">
                          ...
                          <button class="btn btn-sm btn-success" type="submit" id="savebutton" name="submit">Submit<i class="fas fa-arrow-up pl-2"></i></button>
                          <input type="hidden" name="submitinquirycheck" value="true">
