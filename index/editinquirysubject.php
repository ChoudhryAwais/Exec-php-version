...
?>
<?php
if (empty($_POST['editinquirycheck2'])) 
{
  header('Location:editinquiry.php');
}
else
{
  ...
  $submitby=$editinquirydata['Submit_By'];
  $subject_actual_name = $editinquirydata['Subjects'];
  $subjects_actual_name = explode(' ', $subject_actual_name);
  $admission_actual_Fee = $editinquirydata['Admission_Fee'];
  $admission_actual_Discount = $editinquirydata['Admission_Discount'];
  $admission_actual_Total = $editinquirydata['Admission_Total'];
  $tuition_actual_Fee = $editinquirydata['Tuition_Fee'];
  $tuition_actual_Discount = $editinquirydata['Tuition_Discount'];
  $tuition_actual_Total = $editinquirydata['Tuition_Total'];
  $special_actual_Fee = $editinquirydata['Special_Fee'];
  $special_actual_Discount = $editinquirydata['Special_Discount'];
  $special_actual_Total = $editinquirydata['Special_Total'];
  $actual_Fee = $editinquirydata['Actual_Fee'];
  $total_Discount = $editinquirydata['Total_discount'];
  $total_Fee = $editinquirydata['Total_Fee'];
  $discountpackage = $editinquirydata['DiscountPackage'];
                    ...
                    <div class="container">
                      ...
                      <table class="table" style="box-shadow: 1px 1px 5px">
                        <tr>
                          ...
                          <td class="text-right"><i class="fas fa-check-circle text-success" style="font-size: 30px"></i></td>
                        </tr>
                      </table>
                      <table class="table" style="box-shadow: 1px 1px 5px">
                        <tr>
                          ...
                          <div class="col-xl-12">
                            <table class="table" style="box-shadow: 1px 1px 10px">
                              <tr>
                                ...
                                <td><input type="text" name="submitby" class="form-control form-control-sm" value="<?php echo $submitby?>" required></td>
                              </tr>
                            </table>
                          </div>
                        </div>
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-center">
                          ...
                          <input type="hidden" name="editinquirycheck3" value="true">
