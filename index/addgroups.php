...
<?php
	if (!empty($_POST['addgroupscheck'])) 
	{
		$GroupsName = htmlspecialchars(strtoupper($_POST['GroupsName']));
		...
		if (mysqli_num_rows($query2) > 0) 
		{
			...
			{
				if (($row['GroupsName']==$GroupsName)&&($row['ClassesName']==$Classes))
				{
					echo 
						'<input type="hidden" >
						<script>
		...
		if ($i==$no_Of_groups) 
		{
			...
			$date = date('d/m/Y');
			$addnewclass = "INSERT INTO groups(CampusId,DisciplineName,ClassesName,GroupsName,CreatedDate,IsActive)
						VALUES ('$CampusId','$Discipline','$Classes','$GroupsName','$date','$ActiveStatus')";
	       					...
	       					<div class="col-xl-12 mt-5">
	       						<div class="container">
	       							<div class="container" style="font-size: 13px">
	       								<form class="form-group needs-validation" novalidate style="box-shadow: 1px 1px 10px;" action="addgroups.php" method="post">
	       									<table class="table table-bordered" style="line-height: 8px">
	       										...
	       										<tr>
	       											<td>
	       												<input onkeyup="spacefilter(this)" type="text" name="GroupsName" class="form-control text-uppercase form-control-sm" required>
	       											</td>
	       											<td>
	       									...
	       									<div class="row mt-5">
	       										<div class="col-xl-12 text-center p-2">
	       											...
	       											<input type="hidden" name="addgroupscheck" value="true">
	       										</div>
	       									</div>
	       								</form>
	       							</div>
