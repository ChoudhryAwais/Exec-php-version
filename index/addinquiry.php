            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="addinquiryacademic.php" method="post" name="forms" class="form-group needs-validation" novalidate onsubmit="return validation()">
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                          <input class="form-control form-control-sm mt-3" type ="text" id="semaili" name="semail" placeholder="Email">
                        </div>
                      </div>
                      <div class="row">
                      ...
                      <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                          <input class="form-control form-control-sm mt-3" type ="text" id="gemaili" name="gemail" placeholder="Email">
                        </div>
                      </div>
                      <div class="row">
