...
<?php
  if (!empty($_POST['check2'])) 
  {
    ...
    $sname = $studentdata['First_Name'];
    $sfname = $studentdata['Last_Name'];
    $gender =$studentdata['Gender'];
    $dob =$studentdata['DOB'];
    $sreligion =$studentdata['Religion'];
    $sdomicile =$studentdata['Domicile'];
    $scnic =$studentdata['CNIC'];
    $snationality =$studentdata['Nationality'];
    $saddress =$studentdata['Address'];
    $sphone =$studentdata['Phone'];
    $scell =$studentdata['Cell'];
    $semail =$studentdata['Email'];
    $gname =$studentdata['Parent_Name'];
    $gcnic =$studentdata['Parent_CNIC'];
    $gphone =$studentdata['Parent_Contact'];
    $gcell =$studentdata['Parent_Cell'];
    $gemail =$studentdata['Parent_Email'];
    $hearfrom  =$studentdata['HearBy'];
            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="editstudentacademic.php" method="post" name="forms" class="form-group needs-validation" novalidate onsubmit="return validation()">
                    ...
                    <div class="container">
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-right">
                          ...
                          <input type="hidden" name="editstudentcheck1" value="true">
