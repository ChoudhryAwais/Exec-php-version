          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 text-dark text-center p-1 h5 text-capitalize" style="border-radius: 0px 0px 80px 80px;">
                <div class="text-white" style="box-shadow: 1px 1px 2px black;border-radius: 0px 0px 50px 50px;background-color: #0047AB">New Inquiry</div>
              </div>
            ...
            <div class="row mt-5">
              <div class="col-xl-12">
                <div class="container mb-5">
                  ...
                  <form style="box-shadow: 1px 1px 10px;border: 1px solid black;border-radius: 5px;" action="viewinquiry.php" method="post" name="forms" class="form-group needs-validation" novalidate onsubmit="return validation()">
                    ...
                    <div class="container">
                          ...
                          <div class="container p-2" style="box-shadow: 1px 1px 8px">
                            <div class="row text-center">
                              ...
                              <div class="col-xl-4">
                                ...
                                <input type="number" oninput="feecalculator()"  name="admdiscount" id="admdiscount" class="form-control form-control-sm text-center" value="0">
                              </div>
                              <div class="col-xl-4">
                                <label for="admtotal" style="font-size:14px" >Total</label>
                                <input type="text" name="admtotalshow" id="admtotalshow" class="form-control form-control-sm text-center" value="<?php echo $groupadmissionfee?>"  disabled style = "cursor: no-drop;">
                                 <input type="hidden" name="admtotal" id="admtotal" class="form-control form-control-sm text-center" value="<?php echo $groupadmissionfee?>" style = "cursor: no-drop;">
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="container p-2" style="box-shadow: 1px 1px 8px">
                            <div class="row text-center">
                              <div class="col-xl-4">
                                ...
                                <input type="text" name="tuitionfeeshow" id="tuitionfeeshow" class="form-control form-control-sm text-center" value="0" disabled style = "cursor: no-drop;">
                                <input type="hidden" name="tuitionfee" id="tuitionfee" class="form-control form-control-sm text-center" value="0" style = "cursor: no-drop;">
                              ...
                              <div class="col-xl-4">
                                ...
                                <input type="number" oninput="feecalculator()" name="tuitiondiscount" id="tuitiondiscount" class="form-control form-control-sm text-center" value="0">
                              </div>
                              <div class="col-xl-4">
                                <label for="tuitiontotal" style="font-size:14px" >Total</label>
                                <input type="text" name="tuitiontotalshow" id="tuitiontotalshow" class=" text-center form-control form-control-sm" value="0"
                                disabled style="cursor: no-drop;">
                                <input type="hidden" name="tuitiontotal" id="tuitiontotal" class="form-control form-control-sm" value="0"
                          ...
                          <div class="container p-2" style="box-shadow: 1px 1px 8px">
                            <div class="row text-center">
                              <div class="col-xl-4">
                                ...
                                <input type="number" oninput="feecalculator()" name="specialcharges" id="specialcharges" class="form-control form-control-sm text-center" value="0">
                              </div>
                              <div class="col-xl-4">
                                <label for="specialdiscount" style="font-size:14px" >Discount</label>
                                <input type="number" oninput="feecalculator()" name="specialdiscount" id="specialdiscount" class="form-control form-control-sm text-center" value="0">
                              </div>
                              <div class="col-xl-4">
                                <label for="specialtotal" style="font-size:14px" >Total</label>
                                <input type="text" name="specialtotalshow" id="specialtotalshow" class="form-control form-control-sm" value="0" disabled style="cursor: no-drop;">
                                <input type="hidden" name="specialtotal" id="specialtotal" class="form-control form-control-sm" value="0" style="cursor: no-drop;">
                              </div>
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row text-right mt-4 container">
                        ...
                        <div class="col-xl-10 col-md-12">
                          <div class="row text-left">
                            <div class="col-xl-4 col-md-4 border h6 p-1">
                              Actual Fees : <span id="actualfees" class="font-weight-normal"></span>
                              <input type="hidden" name="actualfeesv" id="actualfeesv" value="0">
                            </div>
                            <div class="col-xl-4 col-md-4 border h6 p-1">
                              Total Discount : <span id="totaldiscount" class="font-weight-normal"></span>
                              <input type="hidden" name="totaldiscountv" id="totaldiscountv" value="0">
                            </div>
                            <div class="col-xl-4 col-md-4 border h6 p-1">
                              Total Fees : <span id="totalfees" class="font-weight-normal"></span>
                              <input type="hidden" name="totalfeesv" id="totalfeesv" value="0">
                            </div>
                          </div>
                        </div>
                        <div class="col-xl-1"></div>
                          ...
                          <div class="col-xl-12">
                            <table class="table" style="box-shadow: 1px 1px 10px">
                              <tr>
                                ...
                                <td><input type="text" name="submitby" class="form-control form-control-sm" required></td>
                              </tr>
                            </table>
                          </div>
                        </div>
                      ...
                      <div class="row mt-5 p-2" style="background-color: lightgray">
                        <div class="col-xl-12 col-md-6 text-center">
                          <button type="Reset" name="reset" class="btn btn-danger"><i class="fas fa-reply-all pr-2"></i>Reset</button>
                          <button class="btn btn-success" type="submit" name="submit">Save<i class="fas fa-arrow-right pl-2"></i></button>
                          <input type="hidden" name="inquirycheck2" value="true">
...
<script>
  function feecalculator() 
  {
    ...
    var discountpackage = document.getElementById('discountpackage');
    ...
    if (noofstudysub>discountupto) 
    {
      ...
      discountpackage.value = discountpackage;
    }
    else
    {
      var package = document.getElementById('package');
